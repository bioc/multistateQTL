...
ftp_path <- "http://ftp.ebi.ac.uk/pub/databases/spot/eQTL/sumstats/GTEx/tx/GTEx_tx_"
input_web <- list(lung = paste0(ftp_path, "lung.all.tsv.gz"),
                  thyroid = paste0(ftp_path, "thyroid.all.tsv.gz"),
                  spleen = paste0(ftp_path, "spleen.all.tsv.gz"),
                  blood = paste0(ftp_path, "blood.all.tsv.gz"))
