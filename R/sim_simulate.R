...
#' @param global percent of QTL tests with significant effects shared across all states
#' @param multi percent of QTL tests with significant effects shared across a subset of states.
#' @param k number of multi-state clusters or an array with the cluster assignments.
...
#' 
#' @param key data.frame containing information about how to simulate multistateQTL. 
#'            Generated by `make.simulation.key()`.
#' @param states array of state names
#' @param params list of parameters required to simulate betas and beta errors. 
#'               Generated by `qtleEstimate()` or `qtleParams()`.
#' @param beta_sd The desired standard deviation or an array of sd equal to the
